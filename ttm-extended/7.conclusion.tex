...
We have presented multiple algorithm variants for the eighth case which either calls a single- or multi-threaded \ttt{cblas\_gemm} with small or large tensor slices in parallel or sequentially.
