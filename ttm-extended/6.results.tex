...
For the CESM-ATM data set, LibTorch is $42.02$\% faster than TLIB.

%TODO: can you say what went wrong for which mode for instance?

The runtime tests with tensors from the SDRBench illustrates that TLIB is in most cases faster than competing libraries with only few exceptions.
