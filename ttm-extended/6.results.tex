...
The median library performances are up to $29.85$ GFLOPS/core reaching at most $84.68$\% of TLIB's throughputs. %($24.16$, $29.85$, $28.66$, $14.86$) 
In case of symmetrically shaped tensors, TLIB's median performance is $8.99$ GFLOPS/core.
Other libraries except for TBLIS run at least 2 times slower than TLIB.
TBLIS computes the product with $9.84$ GFLOPS/core and reaches in median $98.63$\% of TLIB's throughput.
...
TLIB outperforms the remaining libraries reaching at most $62.97$\% percent of TLIB's throughputs.
...
It outperforms all other libraries which reach at most $86.67$\% of TLIB's throughputs.
...
\begin{tabular} { l l l }
	\toprule
	Library & Performance [GFLOPS/core] & Ratio [\%] \\
...
%\caption%
%{%
%Intel Xeon Gold top/bottom equals asymmetric/symmetric
%\footnotesize
%}
