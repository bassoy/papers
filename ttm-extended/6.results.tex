...
The last subsection also considers tensors with real-world tensor shapes.
...
The corresponding tensor shapes and their shape sets have been described in subsection \ref{sec:experimental.setup}.
