...
\begin{tabular} { l l l }
	...
	\midrule
	TLIB      & $(9.39 / 37.27 / 38.42 / 57.87)$& \\
	TCL       & $(0.98 / 21.96 / 24.16 / 56.34)$& $(59.38 / 84.69)$\\
	TBLIS     & $(8.33 / 29.23 / 29.85 / 47.28)$& $(83.66 / 80.62)$\\
	LibTorch  & $(1.05 / 24.15 / 28.68 / 46.56)$& $(70.51 / 78.00)$\\
	Eigen     & $(5.85 / 14.06 / 14.89 / 15.67)$& $(39.88 / 36.94)$\\
	\midrule
	TLIB      & $(0.14 / 18.16 / 8.99 / 58.14)$ & \\
	TCL       & $(0.04 /  9.38 / 2.71 / 56.63)$  & $(59.89 / 44.66)$\\ 
	TBLIS     & $(1.11 / 15.37 / 9.84 / 45.03)$ & $(134.71 / 98.63)$\\
	LibTorch  & $(0.07 / 11.07 / 3.52 / 62.20)$ & $(74.56 / 53.32)$\\
	Eigen     & $(0.21 /  6.26 / 3.80 / 16.06)$  & $(42.59 / 31.59)$\\	
	\bottomrule
\end{tabular}
%\caption%
%{%
...
\begin{tabular}{llll}% 
\toprule
Library  & Performance (Max/Min/Avg) & Comparison \\
\midrule
TLIB     & $24.28$    & $100.00$\% \\
TCL      & $8.07$     & $27.97$ \% \\
TBLIS    & $26.81$    & ??? \\
LibTorch & $16.04$    & $62.97$ \\
Eigen    & $11.49$    & $54.64$ \\
\midrule
TLIB     & $7.52$     & $100.00$\\
TCL      & $2.03$     & $44.94$ \\
