...
\addplot[fill=black!40!white] coordinates {(S3D,3.032)};  % tlib_optimized
\addplot[fill=red!40!white] coordinates {(S3D,2.916)};  % tcl
\addplot[fill=yellow!40!white] coordinates {(S3D,3.187)};  % tblis
