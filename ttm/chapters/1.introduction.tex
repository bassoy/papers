...
Our algorithms are in-place and compute the tensor-matrix multiplication in parallel using OpenMP and fast \tf{GEMM} implementations with subtensors or tensor slices.
