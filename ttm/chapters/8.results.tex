...
Fig. \ref{performance.tlib.contour} shows mean performance values of the <omp-par,seq-gemm> version with subtensors or tensor slices and the <gemm-batch> version with subtensors.




the four versions \tf{SB-P1}, \tf{LB-P1}, \tf{SB-PN} and \tf{LB-PN} with asymmetrically-shaped tensors.
