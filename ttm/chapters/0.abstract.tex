...
%
We discuss different tensor slicing methods and parallelization strategies using OpenMP with \tf{GEMM} and batched \tf{GEMM}.
%
Our best implementation attains a median performance of $1.37$ single precision Tflops/s on an Intel Xeon Gold 6248R processor using Intel's \tf{MKL}.
