...
\newcommand{\tttlist}[1]{\tgreen{\tttbf{#1}}}

\newcommand{\tict}{\tttlist{ict}}
\newcommand{\tstd}{\tttlist{std}}
\newcommand{\tP}{\tttlist{P}}
\newcommand{\tA}{\tttlist{A}}
\newcommand{\tS}{\tttlist{S}}
\newcommand{\tV}{\tttlist{V}}
\newcommand{\tF}{\tttlist{F}}
\newcommand{\tD}{\tttlist{D}}
\newcommand{\tN}{\tttlist{N}}
\newcommand{\tT}{\tttlist{T}}

\newcommand{\mtfrac}[2]{{\tiny$\left[\frac{\text{#1}}{\text{#2}}\right]$}}
\newcommand{\mbeta}{\boldsymbol{\eta}}


\newcommand{\tsum}[2]{\sum_{r=#1}^{#2}\bar{n}_r}
\newcommand{\tsumi}[2]{\sum_{r=#1}^{#2}\bar{n}_r'}
\newcommand{\csum}[2]{\sum_{r=#1}^{#2}c_r}
